...
export const Header: React.FC<HeaderProps> = ({
  ...
  const getBreadcrumbTitle = () => {
    switch (activeTab) {
      ...
      default: return 'Globalize System';
    }
  };

  const rolesList: { value: UserRole; labelEn: string; labelAr: string; desc: string }[] = [
    { value: 'owner', labelEn: 'Owner (Ahmed/Abu El-Fotouh)', labelAr: 'المالك (أحمد/أبو الفتوح)', desc: 'Full business stats, partner splits, capital allocations.' },
    { value: 'admin', labelEn: 'Admin Manager (Nada)', labelAr: 'المدير المسؤول', desc: 'Registers tasks, assigns translators, validates filings.' },
    { value: 'sales', labelEn: 'Sales Executive (Samar)', labelAr: 'مسؤول المبيعات', desc: 'Prepares quotations, intake checks, updates task pipelines.' },
    { value: 'accountant', labelEn: 'Accountant (Mostafa)', labelAr: 'المحاسب المالي', desc: 'Controls Cashbook, processes income, reconciles receivables.' },
    { value: 'translator', labelEn: 'Translator (Shaima/Mohamed)', labelAr: 'المترجم اللغوي', desc: 'Views assigned word queue, submits translations.' }
  ];
      ...
      <div className="flex items-center gap-4">
        <div>
          ...
          <div className="flex items-center gap-1.5 text-xs text-slate-500 font-medium font-sans">
            <span className="font-extrabold text-indigo-600">Globalize System</span>
            <span>/</span>
